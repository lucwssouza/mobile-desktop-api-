  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
		...
		<div class="container-fluid">
            <h2 class="text-center display-4">Busca Produtos</h2>
            <div class="row">
                  ...
                  ?>
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            ...
                            <a class="btn btn-info btn-sm" href="editarproduto.php?idprodutos=<?=$linha['idprodutos']?>&nome=<?=$linha['nome']?>&preco=<?=$linha['preco']?>&quantidade=<?=$linha['quantidade']?>">
                                <i class="fas fa-pencil-alt"></i>
                                Editar
                            </a>


                            <a class="btn btn-danger btn-sm" href="excluirproduto.php?idprodutos=<?=$linha['idprodutos']?>&nome=<?=$linha['nome']?>">
