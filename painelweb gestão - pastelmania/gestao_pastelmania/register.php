        ...
        <div class="card-body1">
          <div class="register-box1">
            <div class="card card-outline">
              ...
              <div class="card-body">
                <p class="login-box-msg">Faça o cadastro de usuário</p>
                ...
                <form action="salvausuario.php" method="post">
                  ...
                  <div class="input-group mb-3">
                    <input type="password" class="form-control" placeholder="Repita sua senha" name="senha_confirma">
                    <div class="input-group-append">
                      <div class="input-group-text">
                        <span class="fas fa-lock"></span>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-4">
                      <button name="salva_usuario" type="submit" class="btn btn-primary btn-block">Registrar</button>
                    </div>
                    <!-- /.col -->
                  </div>
                </form>
